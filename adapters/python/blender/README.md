...
This project is based on [DragonFF](https://github.com/Parik27/DragonFF) by [Parik27](https://github.com/Parik27), adapted for [Rengine](https://github.com/reliverse/rengine), and licensed under the GPL-3.0 License. See the [LICENSE](LICENSE) file for details.
