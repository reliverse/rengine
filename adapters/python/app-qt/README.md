...
The Rengine is designed to be a comprehensive solution for modders.
...
| COL Editor | View & edit collision files | Collision model structures, spheres/boxes/meshes, face groups, statistics |
| Map Editor | View & edit IPL map files | Object instances, cull zones, binary/text IPL support, placement data |
...
### DragonFF Integration

This application integrates with [DragonFF](https://github.com/Parik27/DragonFF), a comprehensive Blender addon for GTA file editing. The suite reuses DragonFF's core libraries for advanced file format support:

#### Integrated DragonFF Components
- **COL Support:** Complete collision file parsing and editing (`gtaLib/col.py`)
- **IPL/Map Support:** Item placement and level data handling (`gtaLib/map.py`)
- **Triangle Stripping:** Mesh optimization utilities (`gtaLib/pyffi/utils/`)
- **Material Effects:** 2DFX effects, bump mapping, environment mapping
- **Data Definitions:** Standardized presets and material definitions (`gtaLib/data/`)
- **Import/Export Operations:** File I/O operations (`ops/` directory)

This integration provides production-ready GTA file format support without code duplication.
...
Follow these instructions to get the Rengine up and running on your local machine.
...
This project is based on [RenderWare Modding Suite](https://github.com/Madhav2609/Renderware-Modding-Suite) by [Madhav2609](https://github.com/Madhav2609), adapted for [Rengine](https://github.com/reliverse/rengine), and licensed under the GPL-3.0 License. See the [LICENSE](LICENSE) file for details.
