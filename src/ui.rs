...
fn editor_tools_ui(
    ...
    mut command_event_writer: MessageWriter<TerrainCommandEvent>,
    mut foliage_command_event_writer: MessageWriter<FoliageCommandEvent>,
    mut region_command_event_writer: MessageWriter<RegionCommandEvent>,
    mut zone_event_writer: MessageWriter<ZoneEvent>,
    mut prefab_event_writer: MessageWriter<PrefabEvent>,
