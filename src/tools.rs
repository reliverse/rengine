...
fn update_brush_paint(
    ...
    mut edit_terrain_event_writer: MessageWriter<EditTerrainEvent>,
    mut edit_foliage_event_writer: MessageWriter<EditFoliageEvent>,
    mut edit_regions_event_writer: MessageWriter<EditRegionEvent>,
    // command_event_writer: MessageWriter<TerrainCommandEvent>,
    editor_tools_state: Res<EditorToolsState>,
...
fn handle_brush_events_from_terrain(
    mut evt_reader: MessageReader<TerrainBrushEvent>,
