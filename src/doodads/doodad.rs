...
fn handle_doodad_model_load_failed(
       ...
       mut commands: Commands,
         mut asset_load_events: MessageReader<AssetLoadFailedEvent<Gltf>>,
...
pub(crate) fn add_doodad_collider_markers(
 ...
 //  mut  scene_instance_evt_reader: MessageReader<SceneInstanceReady>
...
pub fn handle_place_doodad_events(
    ...
    mut evt_reader: MessageReader<PlaceDoodadEvent>,

    mut editor_event_writer: MessageWriter<EditorEvent>,
    mut doodad_tool_event_writer: MessageWriter<DoodadToolEvent>,
...
pub fn handle_spawn_doodad_events(
    ...
    mut evt_reader: MessageReader<SpawnDoodadEvent>,
...
pub fn handle_place_clay_tile_block_events(
    ...
    mut evt_reader: MessageReader<PlaceClayTileEvent>,
...
pub fn update_place_doodads(
   mut event_reader: MessageReader<RequestPlaceDoodad>,

    mut event_writer: MessageWriter<PlaceDoodadEvent>,
...
pub fn handle_doodad_tool_events(
    mut event_reader: MessageReader<DoodadToolEvent>,
