...
use bevy::{platform::collections::hash_map::HashMap, prelude::*, window::WindowMode};
// use bevy_inspector_egui::bevy_egui::{egui, EguiContext};
// use egui_dock::{NodeIndex, SurfaceIndex, TabBarStyle, TabIndex};
use bevy_egui::EguiContexts;
use egui_dock::{egui, NodeIndex, SurfaceIndex, TabBarStyle, TabIndex};
...
impl Editor {
    pub(crate) fn system(world: &mut World) {
        world.resource_scope(|world, mut editor: Mut<Editor>| {
            let egui_context = world.resource::<EguiContexts>().primary().ctx.clone();
    ...
    fn editor_menu_bar(
        ...
        egui::TopBottomPanel::top("top_panel").show(ctx, |ui| {
            let bar_response = egui::MenuBar::new().show(ui, |ui| {
