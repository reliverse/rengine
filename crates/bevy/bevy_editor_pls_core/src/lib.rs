...
// TODO: Re-enable when compatible with Bevy 0.18
...
impl Plugin for EditorPlugin {
    fn build(&self, app: &mut App) {
        // TODO: Re-enable inspector plugins when compatible with Bevy 0.18
        ...
        app.insert_resource(Editor::new(window_entity, always_active))
            ...
            .add_systems(
                ...
                Editor::system
                    ...
                    // .before(EguiPostUpdateSet::ProcessOutput),  // Removed in bevy_egui 0.39 
            );
    }
}
