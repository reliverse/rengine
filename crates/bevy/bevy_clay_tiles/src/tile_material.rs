// use bevy::asset::{AssetId, AssetIndex, VisitAssetDependencies};
use bevy::prelude::*;
...
// pub const TILE_SHADER_HANDLE: Handle<Shader> = Handle::from(AssetId::<Shader>::invalid());
pub(crate) const TILE_SHADER_HANDLE: Handle<Shader> = bevy::asset::uuid_handle!("f1e2d3c4-b5a6-7890-abcd-ef0123456789");
