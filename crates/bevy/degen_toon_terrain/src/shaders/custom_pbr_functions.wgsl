#define_import_path degen_toon_terrain::custom_pbr_functions 


//This was copied from bevy 0.15.1 
...
struct ComputedPbrLighting {
    transmitted_light: vec3<f32>,
    direct_light: vec3<f32>,
    indirect_light: vec3<f32>,
    emissive_light: vec3<f32>,
...
fn apply_pbr_lighting(
    ...
    // ----   slightly inefficient to duplicate here   :(    only need for debug ?
     let view_z = dot(vec4<f32>(
        view_bindings::view.view_from_world[0].z,
        view_bindings::view.view_from_world[1].z,
        view_bindings::view.view_from_world[2].z,
