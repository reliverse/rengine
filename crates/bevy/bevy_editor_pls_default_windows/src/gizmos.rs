...
fn add_gizmo_markers(
    ...
    add(&mut commands, point_lights, "PointLight Gizmo", || (
             ...
             Mesh3d(gizmo_marker_meshes.point_light_mesh.clone() ),
            MeshMaterial3d ( gizmo_marker_meshes.point_light_material.clone() ), 
    ...
    add(
        ...
        ||  (
            Mesh3d( gizmo_marker_meshes.directional_light_mesh.clone()),
            MeshMaterial3d( gizmo_marker_meshes.directional_light_material.clone() ),
            ...
            commands
                ...
                .with_children(|commands| {
                    commands.spawn((
                        ...
                        Mesh3d(   gizmo_marker_meshes.camera_mesh.clone() ),
                        MeshMaterial3d( gizmo_marker_meshes.camera_material.clone() ),
